...
import com.rale.advancedandroid.base.TestApplication;
import com.rale.advancedandroid.data.TestRepoService;
...
public class TrendingReposControllerTest {
    ...
    public void loadRepos() {
        ...
        onView(ViewMatchers.withId(R.id.tv_error)).check(matches(withEffectiveVisibility(ViewMatchers.Visibility.GONE)));
