...
public class ScreenInjector {
    ...
    @Inject
    ScreenInjector(Map<Class<? extends Controller>, Provider<AndroidInjector.Factory<? extends Controller>>> screenInjectorors) {
        this.screenInjectors = screenInjectorors;
    }
